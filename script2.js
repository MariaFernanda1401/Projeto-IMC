...
function imc () {
    ...
    if (nome !== '' && altura !== '' && peso !== '') {
        ...
        resultado.textContent = `Olá, ${nome}! Com ${peso}kg e ${altura}m, seu IMC é ${valorIMC}. Atualmente, você está ${classificacao}, tente manter seu peso entre ${pesominimo} e ${pesomaximo}`;
